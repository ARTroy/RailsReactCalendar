...
class EventEditForm extends React.Component {
    ...
    onSubmit = (e) => { 
        e.preventDefault();
        this.props.update_event({ id:this.state.id, title:this.state.title, description:this.state.description, start_datetime:this.state.start_datetime, end_datetime:this.state.end_datetime}); 
            ...
            <form onSubmit={this.onSubmit}>
                <div className="grid-x grid-padding-x">
                    ...
                    <div className="cell small-12">
                        ...
                        <input name="description" type="text" value={ this.state.description } onChange={this.onChange}/> 
                    </div>
                    <div className="cell small-12">
                        <label>start datetime</label>
                    </div>
                    <div className="cell small-6">
                        <input name="start_date" type="date" style={{display: 'inline-block'}} onChange={this.onChange_date}
                    ...
                    <div className="cell small-6">
                        <input name="start_time" type="time" style={{display: 'inline-block'}} onChange={this.onChange_date}
                    ...
                    <div className="cell small-6">
                        <input name="end_date" type="date" style={{display: 'inline-block'}} onChange={this.onChange_date}
                    ...
                    <div className="cell small-6">
                        <input name="end_time" type="time" style={{display: 'inline-block'}} onChange={this.onChange_date}
